...
public enum PlaceCategoryCode {
    ...
    /**
     * @JsonValue: 서버에서 프론트엔드로 응답(Response)을 줄 때, 
     * Enum 이름(STUDY_CAFE) 대신 value 필드("study-cafe")로 직렬화하도록 합니다.
     */
    @JsonValue
    ...
    /**
     * @JsonCreator: 프론트엔드에서 "study-cafe"라는 문자열로 요청(Request)이 오면,
     * 알맞은 Enum 상수(STUDY_CAFE)로 역직렬화(매핑)해줍니다.
     */
    @JsonCreator
