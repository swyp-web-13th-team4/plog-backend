...
public class PostController {
  ...
  private final PostService postService;
    ...
    public ResponseEntity<ApiResponse<PostCreateResponse>> createPost(
            @Parameter(description = "게시글 텍스트 데이터")
            @Valid @RequestPart("texts") PostCreateRequest request,
            @Parameter(description = "게시글 이미지 (최대 5개)")
        ...
        List<ImageUrlResponse> imageResponse = postImageService.uploadPostImages(postResponse.postId(), images);
